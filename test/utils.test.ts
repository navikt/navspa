...
describe("joinPaths", () => {
  it("should join url with path", () => {
    expect(joinPaths("https://example.com", "test")).toBe(
  ...
  it("should extract correct paths from the manifest", () => {
    const testManifest = {
      files: {
        ...
        "precache-manifest.1b3d59df3e178365037cfd06d62a63fc.js":
          "/veilarbdemo/precache-manifest.1b3d59df3e178365037cfd06d62a63fc.js",
        ...
        "static/js/main.js.LICENSE.txt":
          "/veilarbdemo/static/js/main.js.LICENSE.txt",
        "static/media/cv-panel-innhold.less":
          "/veilarbdemo/static/media/rediger.a0d6689d.svg",
        "static/media/printer.f2de876d.svg":
          "/veilarbdemo/static/media/printer.f2de876d.svg",
      },
      entrypoints: ["static/css/main.css", "static/js/main.js"],
    };

    const manifestUrls = createAssetManifestParser("http://localhost:1234")(
      testManifest,
    );
...
describe("makeAbsolute", () => {
  it("should append manifest-path to baseUrl-domain", () => {
    expect(
      Utils.makeAbsolute("http://nav.no/appnavn", "/appnavn/main.js"),
  ...
  it("should use current domain is path is relative", () =>
    new Promise<void>((done) => {
      withCurrentLocation("http://container.app/appname", () => {
        expect(
          Utils.makeAbsolute("/podlet-app", "/podlet-app/static/js/main.js"),
  ...
  it("should prevent duplicate slashes", () =>
    new Promise<void>((done) => {
      withCurrentLocation("http://container.app/appname/", () => {
        expect(
          Utils.makeAbsolute(
            "http://container.app/appname/",
            "/podlet-app/static/js/main.js",
          ),
        ).toBe("http://container.app/podlet-app/static/js/main.js");
  ...
  it("should ensure slashe before asset-path", () =>
    new Promise<void>((done) => {
      withCurrentLocation("http://container.app/appname", () => {
        expect(
          Utils.makeAbsolute("appname", "podlet-app/static/js/main.js"),
        ).toBe("http://container.app/podlet-app/static/js/main.js");
